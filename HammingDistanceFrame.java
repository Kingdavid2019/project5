...
public class HammingDistanceFrame extends JFrame{
	...
	public HammingDistanceFrame() throws IOException {
		...
		// calls calHammDist to be able to use it's methods later
		...
		JPanel panel1 = new JPanel(); // panel that holds the slider
		...
		JPanel panel2 = new JPanel(); // panel that holds the button that will display the stations in panel3
		...
		JPanel panel3 = new JPanel(); // panel that holds textarea that shows stations
		...
		JPanel panel4 = new JPanel(); // has dropdown box
		panel4.add(compareWith);
		panel4.add(stationBox); 
		leftPanel.add(panel4);
		
		JPanel panel5 = new JPanel(); // has button that will calculate hamming distance
		...
		// all the panels that will hold the values of the hamming distances
		...
		JPanel panel11 = new JPanel(); // text box for user input for a new station
		...
		this.add(leftPanel); // adds left panel to the frame
		
		/*
		 * this button is used to reset then left panel
		 * when clicked it will out the textarea and textboxs that have the stations and hammingdistances respectively
		 */
		...
		this.add(rightPanel); // adds button to freezone (right panel)
